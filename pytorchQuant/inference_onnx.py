...
if __name__ == '__main__':
    ...
    dirName = "/home/countai/playground/sl-test/data/deepdata/kirchidata/c/"
    ...
    for i in fileList:
        ...
        if output[0] == 1:
            print("output:-",output)
            print(dirName+i)
            #save in inference dir
            os.makedirs(output_dir+"kirchi/",exist_ok=True)
            cv2.imwrite(output_dir+"kirchi/"+i,image)
        else:
            print("output:-",output)
            print(dirName+i)
            #save in inference dir
            os.makedirs(output_dir+"not_kirchi/",exist_ok=True)
            cv2.imwrite(output_dir+"not_kirchi/"+i,image)
